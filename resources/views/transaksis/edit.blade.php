        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('transaksis.index') }}" class="btn btn-sm btn-outline-secondary me-2">Kembali</a>
                        <button type="submit" form="form-transaksi" class="btn btn-sm btn-outline-success">Simpan Perubahan</button>
                    </div>
                </div>

                <div class="card-body">
                    <form id="form-transaksi" action="{{ route('transaksis.update', $transaksi) }}" method="post">
                        @csrf
                        @method('PUT')
